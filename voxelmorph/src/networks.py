...
# vol_size=dim_MRA_xy.shape; enc_nf= nb_enc_features; dec_nf=nb_dec_features;
# full_size=True; src=None; tgt=None; src_feats=1; tgt_feats=1;


def unet_core(vol_size, enc_nf, dec_nf, full_size=True, src=None, tgt=None, src_feats=1, tgt_feats=1):
    #origianl voxelmorph image size vol_size=(192,160)
    # vol_size = (218, 182)
    # enc_nf = [32, 32, 32, 32]
